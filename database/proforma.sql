...
-- Dumping database structure for proforma
CREATE DATABASE IF NOT EXISTS `proforma` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `proforma`;
...
-- Dumping data for table proforma.brand: ~8 rows (approximately)
...
-- Dumping data for table proforma.disk: ~5 rows (approximately)
...
-- Dumping data for table proforma.disk_size: ~7 rows (approximately)
...
-- Dumping data for table proforma.disk_type: ~2 rows (approximately)
...
-- Dumping data for table proforma.display_panel: ~2 rows (approximately)
...
-- Dumping data for table proforma.display_size: ~8 rows (approximately)
...
-- Dumping data for table proforma.keyboard: ~1 rows (approximately)
...
-- Dumping data for table proforma.memory_ram: ~2 rows (approximately)
...
-- Dumping data for table proforma.memory_ram_frequency: ~19 rows (approximately)
...
-- Dumping data for table proforma.memory_ram_size: ~6 rows (approximately)
...
-- Dumping data for table proforma.mouse: ~1 rows (approximately)
...
-- Dumping data for table proforma.powersupply: ~1 rows (approximately)
...
-- Dumping data for table proforma.powersupply_certificate: ~9 rows (approximately)
...
-- Dumping data for table proforma.powersupply_watts: ~11 rows (approximately)
...
-- Dumping data for table proforma.processor: ~2 rows (approximately)
...
-- Dumping data for table proforma.processor_type: ~0 rows (approximately)
...
-- Dumping data for table proforma.proforma: ~3 rows (approximately)
...
-- Dumping data for table proforma.store: ~6 rows (approximately)
