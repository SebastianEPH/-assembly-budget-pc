...
import {Row, Col, Modal, Button, Form, FloatingLabel, Card, InputGroup, FormControl} from "react-bootstrap";
                            ...
                            <div className="d-grid gap-2 ">
                                ...
                                <div className="input-group ">
                                    <div className="form-check form-switch ">
                                        ...
                                        <label className="form-check-label" htmlFor="flexSwitchCheckDefault">{select==="1"? 'Active':"disable"}</label>
                                    </div>
                                </div>
                            </div>
                        </Col>  {/*Buttons zone*/}
