                        ...
                        <Row >
                            <Col md={11}>
                                ...
                                <Row>
                                    ...
                                    <InputSelect name={"watts"}  title={"Watts"} update={update} select={watts}  col={2} data={dataPowersupplyWatts}/>

                                    <InputSelect name={"certificate"}  title={"Certificate"} update={update} select={certificate}  col={2} data={dataPowersupplyCertificate }/>
