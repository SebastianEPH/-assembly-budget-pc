                        ...
                        <Row >
                            <Col md={11}>
                                ...
                                <Row>
                                    ...
                                    <InputSelect name={"size"} title={"Size"} update={update} select={size} col={2} data={diskSize}/>
                                    <InputSelect name={"type"} title={"Type"} update={update} select={type} col={2} data={diskType}/>
                                     <Col md={3}>
